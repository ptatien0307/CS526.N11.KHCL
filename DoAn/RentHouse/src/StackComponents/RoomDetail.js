                    ...
                    <View style={[styles.basicInfo, styles.myBorder]}>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <View style={[styles.rowItem, styles.myBackground]}>
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('EditModal', { editContent: currRoom.roomName }) }}>
                                    <Text>Tên phòng:</Text>
                            ...
                            <View style={[styles.rowItem, styles.myBackground]}>
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('EditModal', { editContent: currRoom.contractDay }) }}>
                                    <Text>Ngày đến:</Text>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <View style={[styles.rowItem, styles.myBackground]}>
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('EditModal', { editContent: currRoom.price }) }}>
                                    <Text>Giá thuê:</Text>
                            ...
                            <View style={[styles.rowItem, styles.myBackground]}>
                                <TouchableOpacity
                                    onPress={() => { navigation.navigate('EditModal', { editContent: currRoom.deposit }) }}>
                                    <Text>Tiền cọc:</Text>
                    ...
                    <View style={[styles.memberInfo, styles.myBorder]}>
                        <View style={[styles.bodyHeader, { height: '10%', marginBottom: 16 }]}>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <FontAwesomeIcon name="plus-circle" size={20} />
                            </TouchableOpacity>
