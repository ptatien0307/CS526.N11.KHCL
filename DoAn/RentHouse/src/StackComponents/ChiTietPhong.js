...
export default function App({ navigation, route }) {
	const selectedRoomId = route.params.room_id;
	...
	// 		let newRoomStatus = "";
	// 		if (newMemberList.length === 0) newRoomStatus = "Trống";
	// 		else newRoomStatus = newMemberList.length + " người";
	...
	// 						if (mountEdit) setMountEdit(!mountEdit);
	// 					}}
	// 				>
	...
	// 			{/* View Bill */}
	// 			{!mountInfo && (
	// 				<View style={[styles.billContainer, styles.myBorder]}>
