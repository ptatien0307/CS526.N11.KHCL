    ...
    return (
        <View style={styles.container}>
            ...
            < Modal
                ...
                onRequestClose={() => { params.setIsAddModalVisible(false) }}>
                <View style={styles.modalContainer}>
                    <View style={[styles.modalView, styles.myBorder]}>

                        {/* Close button */}
                        <View style={{ position: 'absolute', top: 10, right: 10 }}>
                            <TouchableHighlight onPress={() => { params.setIsAddModalVisible(!params.isAddModalVisible) }}>
                                ...
                                if (params.inputText === '')
                                    ...
                                    if (params.notes.length === 0) {
                                        ...
                                        newNote = [
                                            ...params.notes,
                                            {
                                                id: params.notes[params.notes.length - 1].id + 1,
                                                noteContent: params.inputText
                                            }
                                        ]
                                    }
...
export function ModalEdit(params) {
    ...
    const editRoom = () => {
        ...
        if (params.inputText === '')
            ...
            params.setSpecRoom({ ...params.specRoom, [params.editItemContent]: params.inputText })
    ...
    return (
        <View style={styles.container}>
            <Modal
                ...
                onRequestClose={() => { params.setIsEditModalVisible(false) }}>
                <View style={styles.modalContainer}>
                    <View style={[styles.modalView, styles.myBorder]}>
