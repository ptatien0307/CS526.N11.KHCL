...
export default function MyCalculator() {
    ...
    const storeData = async (value) => {
        try {
            ...
            await AsyncStorage.setItem('b', jsonValue)
        } catch (e) {
    ...
    const handleInputText = (button) => {
        if (button === '=') {
            ...
            // Storing data to load again if the app is closed
            storeData([
                {
                    id: historyID,
                    in: textToShow,
            ...
            <View style={[styles.calculator, { display: !showHistory ? 'flex' : 'none' }]}>
                ...
                <View style={[styles.bodyContainer]}>
                    ...
                    >
                        ...
                        <View style={[styles.basicButtonsContainer, { display: width > height ? 'flex' : showBasicBtn ? 'flex' : 'none' }]}
                        >
                            {
